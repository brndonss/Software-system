...
const productMenuGroups = [{ label: "CREATE", items: [{ title: "AI", target: "resources" }, { title: "Setup", target: "how-it-works" }, { title: "System", target: "platform", route: "/platform/system" }] }, { label: "BUILD", items: [{ title: "Customers", target: "solutions" }, { title: "Workflows", target: "automations" }, { title: "Automations", target: "automations" }] }, { label: "OPERATE", items: [{ title: "Tasks", target: "automations" }, { title: "Activity", target: "resources" }, { title: "Insights", target: "resources" }] }];
