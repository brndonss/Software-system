...
const productMenuGroups = [{ label: "CREATE", items: [{ title: "AI", target: "resources", comingSoon: false }, { title: "Agents", comingSoon: true }, { title: "Design", comingSoon: true }, { title: "External Agents", comingSoon: true }] }, { label: "BUILD", items: [{ title: "CMS", comingSoon: true }, { title: "Hosting", comingSoon: true }, { title: "Performance", comingSoon: true }, { title: "Collaborate", comingSoon: true }] }, { label: "GROW", items: [{ title: "SEO", comingSoon: true }, { title: "AEO", comingSoon: true }, { title: "Convert", comingSoon: true }, { title: "Publish", comingSoon: true }] }];
