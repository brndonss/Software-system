...
const productMenuGroups: { label: string; items: ProductMenuItem[] }[] = [{ label: "OPERATE", items: [{ title: "Customers", comingSoon: true }, { title: "Leads", comingSoon: true }, { title: "Tasks & Follow-ups", comingSoon: true }] }, { label: "AUTOMATE", items: [{ title: "Workflows", comingSoon: true }, { title: "Automations", comingSoon: true }] }, { label: "UNDERSTAND", items: [{ title: "Activity", comingSoon: true }, { title: "AI", route: "/platform/ai", comingSoon: false }] }];
...
const resourcesMenuGroups: { label: string; items: ResourcesMenuItem[] }[] = [{ label: "BUSINESS TOOLS", items: [{ title: "Templates", route: "/resources/templates" }, { title: "Workflow Library", route: "/resources/workflows" }, { title: "Automation Library", route: "/resources/automations" }] }, { label: "LEARN", items: [{ title: "Guides", route: "/resources/guides" }, { title: "Articles", route: "/resources/articles" }, { title: "Getting Started", route: "/resources/getting-started" }] }, { label: "SUPPORT", items: [{ title: "Help Center", route: "/resources/help" }, { title: "What's New", route: "/resources/whats-new" }, { title: "Contact", route: "/resources/contact" }] }];
